#!/usr/bin/env node
/* Cross-app goal contract — this repo is the CONSUMER side.
 *
 ...
 *
 * greencross-leaderboard publishes the other half.
 *
...
try {
  ...
  console.log('\n^ CROSS-APP CONTRACT BROKEN. This repo is the CONSUMER.');
  process.exit(1);
}
